...
export default function ReciboPDF({ order, companySettings, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
      <div className="bg-white text-neutral-900 max-w-3xl w-full rounded-2xl shadow-2xl p-8 sm:p-12 space-y-8 my-8 print:p-0 print:shadow-none print:w-full print:max-w-none font-sans relative">
