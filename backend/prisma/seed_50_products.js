...
const mockProducts = [
  // --- ASSENTOS & CADEIRAS ---
  {
    ...
    categoryName: 'Assentos & Cadeiras',
    categorySlug: 'assentos-cadeiras',
    departmentSlug: 'mobiliario-lounges',
    priceDaily: 14.50,
    priceWeekly: 65.00,
    stock: 200,
  ...
  // --- MESAS & BANCADAS ---
  {
    ...
    categoryName: 'Mesas & Bancadas',
    categorySlug: 'mesas-bancadas',
    departmentSlug: 'mobiliario-lounges',
    priceDaily: 8.00,
    priceWeekly: 35.00,
    stock: 100,
  ...
  // --- TENDAS & ESTRUTURAS ---
  {
    ...
    categoryName: 'Tendas & Coberturas',
    categorySlug: 'tendas-coberturas',
    departmentSlug: 'estruturas-climatizacao',
    priceDaily: 180.00,
    priceWeekly: 720.00,
    stock: 30,
  ...
  // --- CLIMATIZAÇÃO & ILUMINAÇÃO ---
  {
    ...
    categoryName: 'Climatização & Iluminação',
    categorySlug: 'climatizacao-iluminacao',
    departmentSlug: 'estruturas-climatizacao',
    priceDaily: 110.00,
    priceWeekly: 440.00,
    stock: 35,
  ...
  // --- KITS & COMBOS DE AMBIENTES ---
  {
    ...
    categoryName: 'Combos & Kits Prontos',
    categorySlug: 'combos-kits-prontos',
    departmentSlug: 'kits-ambientes',
    isKit: true,
    priceDaily: 650.00,
    priceWeekly: 2600.00,
    stock: 10,
...
async function main() {
  console.log('🌱 Iniciando inclusão dos produtos corporativos...');
  ...
  for (const item of mockProducts) {
    ...
    const category = await prisma.category.upsert({
      ...
      create: { name: item.categoryName, slug: item.categorySlug, departmentId: depId }
    });
  ...
  console.log(`✅ Produtos corporativos ricos atualizados no banco de dados com sucesso!`);
}

main()
  .catch((e) => {
    console.error('❌ Erro no seed de produtos:', e);
    process.exit(1);
  })
  .finally(async () => {
